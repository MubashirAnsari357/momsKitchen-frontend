...
const UserStackNavigation = () => {
  ...
  return (
    loading ? <Loading /> : <NavigationContainer>
      <Stack.Navigator initialRouteName={onBoardedStatus ? 'UserTabNavigation' : 'OnboardingScreen'}>
        <Stack.Screen
        ...
        <Stack.Screen
          name="ChefSignup1"
          component={ChefSignup1}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="ChefSignup2"
          component={ChefSignup2}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Camera"
